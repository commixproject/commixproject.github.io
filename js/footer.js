          ...
          <div class="col-md-12">
            <p class="pull-left">
              <small class="block">
                ...
                <br>
                <a href="https://github.com/commixproject/" target="_blank">Commix Project</a> is licensed under the <a href="https://github.com/commixproject/commix/wiki/License" target="_blank">GPLv3 License</a> © 2014-2025.
              </small>
            </p>
            <p class="pull-right">
              <br>
